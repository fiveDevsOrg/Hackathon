  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Pulsing highlight ring around the nudge target
        "ring-pulse": {
          "0%,100%": {
            boxShadow:
              "0 0 0 0 rgba(255,107,53,0.55), 0 0 0 1px rgba(255,138,94,0.9), 0 0 34px -4px rgba(255,107,53,0.7)",
          },
          "50%": {
            boxShadow:
              "0 0 0 9px rgba(255,107,53,0), 0 0 0 1px rgba(255,138,94,0.9), 0 0 40px 0 rgba(255,107,53,0.85)",
          },
        },
        // Ghost cursor tap feedback
        "cursor-tap": {
        ...
        // Confetti fall for the celebration
        "confetti-fall": {
          "0%": { transform: "translateY(-12vh) rotate(0deg)", opacity: "1" },
          "100%": { transform: "translateY(112vh) rotate(620deg)", opacity: "0" },
        },
        // Gentle attention shimmer on a wrong-click toast
        "shake-x": {
      ...
      animation: {
        ...
        "cursor-tap": "cursor-tap 0.9s ease-in-out infinite",

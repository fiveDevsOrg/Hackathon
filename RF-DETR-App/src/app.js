import { createGestureWorkspace } from "./gesture-trainer.js?v=swipe-strict-1";
import { createHandTracker } from "./hand-tracker.js?v=swipe-strict-1";
import { createArenaScene } from "./three-scene.js?v=swipe-strict-1";
